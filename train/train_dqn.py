...
EVAL_FREQ        = 250   # episodes
SAVE_FREQ        = 500
K                = 4
SELF_PLAY_START  = 500   # episode to switch from random opponent to self-play
...
def _make_frozen_opponent(agent: RainbowDQN, epsilon: float = 0.05):
    # deep copy so the frozen weights don't change as the online net trains
